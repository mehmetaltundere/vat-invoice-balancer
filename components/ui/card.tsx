...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-3xl border border-white/10 bg-[#2c2c2e]/60 backdrop-blur-2xl text-white shadow-2xl transition-all duration-300",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-xs text-zinc-400 leading-relaxed font-medium", className)}
    {...props}
  />
));
